...
$("#previous-page").click(function()
    ...
    function togleCategories(event)
	{
       var activateButton = event.target;
		  ...
		  var topPosition = 60 + pageYOffset + "px";
...
(function()
  {
	...
	function changeMenu(entries)
	{
		if(!firstTime)
		{
				...
				{
				   const ratio = element.intersectionRatio;
	...
	var observer = new IntersectionObserver(changeMenu, settings);
