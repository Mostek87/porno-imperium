...
<html lang="pl" dir="ltr">
  <head>
    <meta charset="UTF-8"/>
	<title>Porno-Imperium : główna strona</title>
	<meta name="description" content="Porno Imperium - darmowe wyszukiwanie(innowacyjna wyszukiwarka), oglądanie i pobieranie filmów(również dla niezalogowanych), 
	intuicyjny interfejs, nie za dużo reklam">
	<meta name="keywords" content="porno, imperium, wyszukiwarka, filmy, dupeczki, seks, wytryski, sperma, pizdeczki">
...
<nav class="main_nav">
	<ul id="menu" class="action_list_main">
	 ...
	 <div class="decoration-images-container  <?php echo $this->dataPackage->pageControls->randomImage1; ?>">  
	    <div class="decoration-image-inner <?php echo $this->dataPackage->pageControls->randomImage2; ?>"></div>
	 </div>
	 
 <h1 id="najnowsze-filmy-porno" class="new-movies">Nowości</h1>	 
...
<ul id="bottom-controls" data-active-page="<?php echo $this->model->currentPage; ?>" data-last-page="<?php echo $this->dataPackage->pageControls->maxPageIndex; ?>" class="page-toggle-controls">
  
    <li class="controls-element">
     <button id="previous-page" class="page-selection page-selection-first-layer"><<</button>
   </li>
   
  <?php $this->createPageNumbers(); ?>
   
   <li class="controls-element">
     <button id="next-page" class="page-selection page-selection-first-layer">>></button>
   </li>
   
   <?php $this->createBackForwardControls(); ?>
...
<div id="cover-canvas" class="dark-canvas"></div>
  ...
  <script src="/js/bottom-controls.js"></script>
