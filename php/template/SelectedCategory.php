...
<html lang="pl" dir="ltr">
  <head>
    <meta charset="UTF-8"/>
	<title>Filmy porno w kategorii : <?php echo $this->pageHeader; ?></title>
	<meta name="description" content="Starannie dobrany zbiór filmów porno w kategorii <?php echo $this->pageHeader; ?>. Pobieranie, komentowanie i ocenianie również dla niezalogowanych">
	<meta name="keywords" content="porno, filmy, kategorie, <?php echo $this->pageHeader; ?>" >
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="author" content="Cybertron">
	<link rel="stylesheet" href="/css/chosen-category.css">
	<link href='https://fonts.googleapis.com/css?family=Exo+2:400,400italic|Monda' rel='stylesheet' type='text/css'>	
    <link href='http://fonts.googleapis.com/css?family=Baloo+Da|Russo+One|Catamaran|Play|Hind|Lalezar&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
  </head>
...
<div class="selected-category <?php echo $this->cssClassName; ?>">
 <h1 class="category-name"><?php echo $this->pageHeader; ?></h1>
</div>	
